...
AnimatedLinkedList.prototype.draw = function(context)
{
	...
	context.closePath();
	var gradient = context.createLinearGradient(100, 100, 100, 0);
	...
	context.lineTo(startX +20, startY+this.h);
	var gradient = context.createLinearGradient(100, 100, 100, 0);
        gradient.addColorStop("0", "magenta");
        gradient.addColorStop("0.5", "blue");
        gradient.addColorStop("1.0", "red");
	...
	context.fill();
	context.beginPath();
	context.moveTo(startX+55 ,startY);
	context.lineTo(startX +55, startY+this.h);
	var gradient = context.createLinearGradient(100, 100, 100, 0);
        gradient.addColorStop("0", "magenta");
        gradient.addColorStop("0.5", "blue");
        gradient.addColorStop("1.0", "red");
