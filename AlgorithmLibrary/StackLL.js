...
var LINKED_LIST_ELEMS_PER_LINE = 6;
var LINKED_LIST_ELEM_SPACING = 130;
var LINKED_LIST_LINE_SPACING = 130;
...
var PUSH_LABEL_X = 70;
var PUSH_LABEL_Y = 20;
var PUSH_ELEMENT_X = 140;
var PUSH_ELEMENT_Y = 100;
...
function openPushPseudocode()
{
	closePopPseudocode();
	document.getElementById("pushPseudocode").style.width = "300px";
	document.getElementById("pushPseudocode").style.padding = "10px";
}

		
function closePushPseudocode()
{
	document.getElementById("pushPseudocode").style.width = "0px";
	document.getElementById("pushPseudocode").style.padding = "0px";
}

function openPopPseudocode()
{
	closePushPseudocode();
	document.getElementById("popPseudocode").style.width = "300px";
	document.getElementById("popPseudocode").style.padding = "10px";
}

function closePopPseudocode()
{
	document.getElementById("popPseudocode").style.width = "0px";
	document.getElementById("popPseudocode").style.padding = "0px";
}	
...
StackLL.prototype.push = function(elemToPush)
{
	...
	this.cmd("CreateLinkedList",this.linkedListElemID[this.top], "Null" ,LINKED_LIST_ELEM_WIDTH, LINKED_LIST_ELEM_HEIGHT, 
		LINKED_LIST_INSERT_X, LINKED_LIST_INSERT_Y, 0.1, 0, 1, 1);
